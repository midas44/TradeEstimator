...
namespace TradeEstimator.Data
{
    ...
    public class Gridset
    {
        ...
        public Gridset(string type, int trade_start_index, int trade_end_index, DaysQuotes Bars, double adr)
        {
            this.type = type;
            ...
            price_daybreak[0] = Bars.Open[daybreak_index] - 3 * adr;
            price_daybreak[1] = Bars.Open[daybreak_index] + 3 * adr;
        }
    }
